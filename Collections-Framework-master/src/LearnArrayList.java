...
public class LearnArrayList {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<String> studentName = new ArraytList<>();
        studentName.add("raksesh");
...
//        System.out.println(list);
//
         System.out.println(list.contains(500));// true or false 0(1)

          list.remove(index: 1);  // This will remove the element at index 1 i.e 20.
//        System.out.println(list);
//
...
remove from middle 0(n);
add at the beginning 0(n);
set 0(1);
